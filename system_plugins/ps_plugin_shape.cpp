...
constexpr psapi::sfm::IntRect    kRectButtonTextureArea = {128, 64, 64, 64};

bool loadPlugin() {
    texture = psapi::sfm::ITexture::create().release();
    texture->loadFromFile("./assets/buttons.png");

    auto ellipse_sprite = psapi::sfm::ISprite::create();
    ellipse_sprite->setTexture(texture);
    ellipse_sprite->setTextureRect(kEllipseButtonTextureArea);

    auto rect_sprite = psapi::sfm::ISprite::create();
    rect_sprite->setTexture(texture);
    rect_sprite->setTextureRect(kRectButtonTextureArea);
    ...
    auto ellipse_button = std::make_unique<ps::ABarButton>(std::move(ellipse_sprite),
                                                           toolbar,
    ...
    auto rect_button = std::make_unique<ps::ABarButton>(std::move(rect_sprite),
                                                        toolbar,
